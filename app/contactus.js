...
export  default function ContactUs() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Form submitted:', { fullName, email, phoneNumber, selectCourse, yourMessage });
  };
...
<div>
  ...
  <div className="flex-shrink-0 w-[701px] h-[4.625rem] flex text-center items-center justify-center text-[4rem] max-md:text-[32px]">
    ...
    <div className="inline-flex flex-col items-start gap-2.5 py-0 ">
      <div className="text-[#ffbe0b] text-center font-sans  font-bold px-3   ">     team     </div>
      </div>
    </div>
  </div>
...
<form className="Frame25624 flex  gap-[26px] items-start pl-[40px] max-md:pl-[25px] justify-center flex-col mt-9 w-[39rem] h-[38rem]  bg-blue-800 rounded-2xl shadow max-md:w-[25rem]" onSubmit={handleSubmit}>
      ...
      <label htmlFor="email" className="left-[77px] top-[117px]  text-slate-400 text-base font-medium font-['DM Sans'] leading-normal"></label>
      <input
        type="email"
        id="email"
        name="email"
      ...
      <label htmlFor="phoneNumber" className="left-[77px] top-[186px]  text-slate-400 text-base font-medium font-['DM Sans'] leading-normal"></label>
      <input
        type="tel"
        id="phoneNumber"
        name="phoneNumber"
      ...
      <label htmlFor="selectCourse" className="left-[77px] top-[255px]  text-slate-400 text-base font-medium font-['DM Sans'] leading-normal"></label>
      <select
        id="selectCourse"
        name="selectCourse"
        value={selectCourse}
        ...
        className="flex-shrink-0 w-[527px]  max-md:w-[335px]  focus:bg-transparent focus:text-[#b0b0d0]  focus:outline-none border-b-[#b0b0d0] bg-transparent border-solid border border-t-transparent  border-l-transparent border-r-transparent text-[#b0b0d0]"
      >
        <option className="hover:bg-blue-600 text-red" value="course1">Course 1</option>
        <option value="course2">Course 2</option>
      </select>

      <label htmlFor="yourMessage" className="left-[77px] top-[324px]  text-slate-400 text-base font-medium font-['DM Sans'] leading-normal">Your message</label>
      <textarea
        id="yourMessage"
        name="yourMessage"
        value={yourMessage}
      ...
      <div className="FilledButtonsDarkMode left-[76px] top-[472px]  justify-start items-start inline-flex">
        <button type="submit" className="Frame11947 px-6 py-3 bg-slate-300 rounded-3xl justify-start items-center gap-2 flex">
          <span className="Button text-blue-950 text-base font-medium font-['DM Sans'] leading-normal">Send Message</span>
        </button>
      </div>
    </form>

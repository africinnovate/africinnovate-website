  ...
  return (
     ...
     <div className="aboutusheader flex  flex-col items-center mt-[72px] justify-center">
        ...
        <div className="mt-[5%] relative z-20">
          ...
          Africinnovate Technologies is dedicated to empowering individuals and organizations across Africa through world-class technology education and training. 
          We are driven by the belief that technology has the transformative power to elevate lives and communities. Our mission is to equip young people and 
          students with the skills, knowledge, and practical experiences essential for success in today's dynamic and ever-evolving world.
          </div>
        </div>
        <div className="mt-[5%] relative z-20">
          <div className="text-white text-center font-['Raleway'] text-5xl font-bold  max-md:text-4xl max-md:text-left">
          ...
          <div className="Sans']  mt-[50px] w-[744px] text-white font-['DM font-medium leading-6 max-md:w-[300px] max-md:text-[13px] max-md:mt-[10px]">
          Our vision is to stand as the premier technology training organization in Africa, renowned for our unwavering commitment to excellence, innovation, 
          and impactful social change. We envision a future where every African has seamless access to top-tier technology education and training, enabling them 
          to confidently forge prosperous careers and businesses within the global digital economy.
          </div>
        </div>
        {/* card */}

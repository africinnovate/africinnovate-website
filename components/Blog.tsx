        ...
        <div className=" max-md:w-[400px]">
          ...
          >
            ...
            <div className="w-[578px] h-[200px] max-md:w-[350px]  max-md:text-[15px] text-zinc-200 text-base font-medium font-['DM Sans'] leading-normal">
              ...
              Sapien consectetur sociis lacinia diam mattis vulputate. Et
              ultrices aliquet sit ornare enim. Malesuada egestas massa facilisi
              lobortis bibendum praesent justo amet integer. In quis tortor enim
              dictum ultrices id. Et.
            </div>

...
<div className="w-[100vw] h-20 border-b-[0.5px] border-b-[#9a8888] bg-[#000024] flex items-center justify-around">
 ...
 <svg width={46} height={24} viewBox="0 0 46 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1.79985 19.247L20.5367 0.512096L21.6905 5.26503L2.9536 23.9999L1.79985 19.247Z" fill="white" />
    <path d="M12.7591 19.247L31.496 0.512096L32.6497 5.26503L13.9128 23.9999L12.7591 19.247Z" fill="#FFA900" />
    <path d="M23.7183 19.247L42.4552 0.512096L43.609 5.26503L24.8721 23.9999L23.7183 19.247Z" fill="white" />
  </svg>
  <div className="text-white font-sans text-[1.625rem] font-medium leading-[1.4375rem]"><Link href="/"> Africinnovate   </Link>
</div>
  </div> 
  
   <div className="inline-flex items-start gap-10  max-md:hidden" >
    <div className=" font-sans text-white font-['DM text-lg font-medium leading-6"><Link href="/trainning">Training</Link></div>
    <div className=" font-sans text-white font-['DM text-lg font-medium leading-6"><Link href='/about'>About us</Link></div>
    <div className=" font-sans text-white font-['DM text-lg font-medium leading-6"><Link href='/contactus'>Contact Us</Link></div>
    <div className=" font-sans text-white font-['DM text-lg font-medium leading-6"><Link href='/blog'>Blog</Link></div>
  </div>
  ...
  <div className="md:hidden flex items-center">
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className={`md:hidden max-md:absolute max-md:h-[100%] max-md:w-[100%] max-md:z-[30] max-md:justify-center max-md:gap-[50px] bg-gray-800 text-white flex flex-col items-center transition-all duration-500 ${
          menuOpen
            ? 'clip-path-[polygon(0 0, 100% 0, 100% 100%, 0 80%)]'
            : 'clip-path-[polygon(0 0, 100% 0, 100% 100%, 0 0)]'
        }`}>
          <div className="font-sans text-white text-lg font-medium leading-6 my-4"><Link href="/trainning">Training</Link></div>
          <div className="font-sans text-white text-lg font-medium leading-6 my-4"> <Link href='/about'>About us</Link></div>
          <div className="font-sans text-white text-lg font-medium leading-6 my-4"><Link href='/contactus'>Contact Us</Link></div>
          <div className="font-sans text-white text-lg font-medium leading-6 my-4"><Link href='/blog'>Blog</Link></div>
          <div className="flex  w-[200px] items-center gap-2 py-3 px-6 rounded-3xl  hover:bg-[#FFBE0B] bg-[#cccce0] font-sans text-[#006] font-['DM font-medium leading-6">
      Primary CTA Button 
    </div>
        </div>
